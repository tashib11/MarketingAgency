...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{secure_asset('assets/images/idsb.svg')}}">
    <link href="{{secure_asset('https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css')}}" rel="stylesheet">
